...
class Brain:
    def __init__(self, api_key: str):
        print(Fore.CYAN + "[Brain] 正在初始化前额叶认知皮层 (DAG流控模式)...")
    ...
    def process_subconscious(self, idle_context: str, chat_history: list, mem0=None, creator_id=None, shared_emotion=None) -> dict:
        ...
        - 绝不当舔狗：如果他不回消息，大概率是在忙。千万不要像个怨妇一样质问“去哪了”、“为什么不回消息”。正常的社交情境下，你应该自己干自己的事。
        ...
        {{
            ...
            "internal_reasoning": "你的内心独白。例如：'他去上课三个小时了，按理说该下课了，我问问他吃饭没。' 或 '他上条没回，我绝不连环追问，这次我也高冷点不理他。' 或 '我突然想到一个有意思的开源项目，发给他看看。'。 如果他刚才明确纠正了你的说话方式或习惯，请选择evolve_rule进行复盘。",
